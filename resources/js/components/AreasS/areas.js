export default
 [
    ...
    "title":"Масаж", "description":"Стилізований масажний кабінет, запаморочливі аромати та спеціалісти по естетиці тіла «розкажуть» Вам про усю філософію релаксу, оздоровлення та зарядження енергією."}
  ]
