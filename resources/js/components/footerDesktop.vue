...
<div class="footer">
  <div class="line-1">
    ...
    <div class="social-networks">
      <a :href="`https://www.facebook.com/${($root.$data.area === 'b' ? 'blevel.gbs' : 'gbs.level')}`" class="facebook" target="_blank">
      ...
      <a :href="`https://www.instagram.com/${($root.$data.area === 'b' ? 'blevel.gbs' : 'gbs.level')}`" class="instagram" target="_blank">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  .line-3{
    ...
    .design-text{
      ...
      .design-logo{
        ...
        height: 23px;
        width: 71px;
        background: url("../../assets/images/design-logo.svg") no-repeat;
      }
    }
  }
}
