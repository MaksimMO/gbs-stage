            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route("workouts.index") }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                Типи тренувань
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('schedule.index') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                Список тренувань
                            </a>
                        </li>
                    <!--<li class="nav-item">
